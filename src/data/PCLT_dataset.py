...
class PET_CT_Dataset(Dataset):
    ...
    def _read_data(self, image_id):
        pet_path = os.path.join(
            self.img_root, "{0}/{1}{2}").format(image_id.split("_")[0], image_id, self.pet_suffix)
        mask_path = os.path.join(
            self.img_root, "{0}/{1}{2}").format(image_id.split("_")[0], image_id, self.mask_suffix)
        ct_path = os.path.join(
            self.img_root, "{0}/{1}{2}").format(image_id.split("_")[0], image_id, self.ct_suffix)
